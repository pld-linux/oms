...
Summary(pl.UTF-8):	Środowisko multimedialne Open Media System
Name:		oms
Version:	0.1.2
Release:	3
License:	GPL
...
Środowisko multimedialne Open Media System (OMS)

%package devel
Summary:	Development libraries and headers of OMS
Summary(pl.UTF-8):	Pliki nagłówkowe do OMS
